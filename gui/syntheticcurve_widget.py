...
class Ui_SyntheticCurveWidget(object):
    def setupUi(self, SyntheticCurveWidget):
        ...
        SyntheticCurveWidget.resize(1003, 619)
        ...
        self.light_treewidget_2.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        ...
        self.light_treewidget_2.setAutoExpandDelay(-1)
        ...
        self.light_treewidget_2.setExpandsOnDoubleClick(True)
        ...
        item_0 = QtWidgets.QTreeWidgetItem(self.light_treewidget_2)
        item_0 = QtWidgets.QTreeWidgetItem(self.light_treewidget_2)
        self.light_treewidget_2.header().setVisible(True)
        self.light_treewidget_2.header().setCascadingSectionResizes(False)
        self.light_treewidget_2.header().setDefaultSectionSize(125)
    ...
    def retranslateUi(self, SyntheticCurveWidget):
        ...
        self.light_treewidget_2.topLevelItem(0).setText(0, _translate("SyntheticCurveWidget", "a (R☉)"))
        self.light_treewidget_2.topLevelItem(1).setText(0, _translate("SyntheticCurveWidget", "M1 (M☉)"))
        self.light_treewidget_2.topLevelItem(2).setText(0, _translate("SyntheticCurveWidget", "M2 (M☉)"))
        self.light_treewidget_2.topLevelItem(3).setText(0, _translate("SyntheticCurveWidget", "R1 (R☉)"))
        self.light_treewidget_2.topLevelItem(4).setText(0, _translate("SyntheticCurveWidget", "R2 (R☉)"))
        self.light_treewidget_2.topLevelItem(5).setText(0, _translate("SyntheticCurveWidget", "Teff1 (K)"))
        self.light_treewidget_2.topLevelItem(6).setText(0, _translate("SyntheticCurveWidget", "Teff2 (K)"))
        self.light_treewidget_2.topLevelItem(7).setText(0, _translate("SyntheticCurveWidget", "logg1 (cgs)"))
        self.light_treewidget_2.topLevelItem(8).setText(0, _translate("SyntheticCurveWidget", "logg2 (cgs)"))
        self.light_treewidget_2.topLevelItem(9).setText(0, _translate("SyntheticCurveWidget", "Mbol1 (mag)"))
        self.light_treewidget_2.topLevelItem(10).setText(0, _translate("SyntheticCurveWidget", "Mbol2 (mag)"))
        self.light_treewidget_2.topLevelItem(11).setText(0, _translate("SyntheticCurveWidget", "log (L1/L☉)"))
        self.light_treewidget_2.topLevelItem(12).setText(0, _translate("SyntheticCurveWidget", "log (L2/L☉)"))
        self.light_treewidget_2.topLevelItem(13).setText(0, _translate("SyntheticCurveWidget", "Vrot1 (km/s)"))
        self.light_treewidget_2.topLevelItem(14).setText(0, _translate("SyntheticCurveWidget", "Vrot2 (km/s)"))
