...
class Ui_SyntheticCurveWidget(object):
    def setupUi(self, SyntheticCurveWidget):
        ...
        self.gridLayout_2.addWidget(self.light_plot_widget, 4, 0, 1, 4)
    ...
    def retranslateUi(self, SyntheticCurveWidget):
        ...
        self.vel_pri_radiobtn.setText(_translate("SyntheticCurveWidget", "Primary Curve"))
        self.vel_sec_radiobtn.setText(_translate("SyntheticCurveWidget", "Secondary Curve"))
